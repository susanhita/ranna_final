...
public class RecipeDatabase  extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
      //  updatemyDatabase(db, oldVersion, newVersion);
        if (oldVersion<4) {
           // Uri path2 = Uri.parse("android.resource://com.habijabi.mealplanner/" + R.drawable.default_pic);
            //String recipe_description2 = "asshole";
            //insertDrink(db, "rubbish", recipe_description2, path2);
